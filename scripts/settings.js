...
function initSdk(name) {
    ...
    const chatWidgetSettings = {
        URI: 'oda-3513d4cd67c34199b780046508bddab9-da6f7264.data.digitalassistant.oci.oraclecloud.com',                               // ODA URI, only the hostname part should be passed, without the https://
        ...
        channelId: '0df1a532-c69b-49a2-aa92-78e29bd2f27a',
  launcherIconUrl: 'https://docs.oracle.com/en/dcommon/artie/img/botButtonIcon.gif',                   // Channel ID, available in channel settings in ODA UI, optional if client auth enabled
        ...
        i18n: {                                     // Provide translations for the strings used in the widget
            en: {                                   // en locale, can be configured for any locale
                chatTitle: 'Public Safety Assistant'       // Set title at chat header
            }
        },
        ...
        icons: {
            launch: "https://docs.oracle.com/en/dcommon/artie/img/botButtonIcon.gif",
            logo: "https://docs.oracle.com/en/dcommon/artie/img/botButtonIcon.gif",
            avatarAgent: "https://docs.oracle.com/en/dcommon/artie/img/botButtonIcon.gif",
            ...
            avatarBot: "https://docs.oracle.com/en/dcommon/artie/img/botButtonIcon.gif"
        }
    };
    ...
    return new Promise(function (resolve) {
        setTimeout(function () {
            ...
            const payload = {
                ...
                exp: now + 3600,
                channelId: '<channelID>',
  launcherIconUrl: '/images/mybot.jpg',
                userId: '<userID>'
            };
